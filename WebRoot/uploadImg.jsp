...
<!--  
  ...
  if(flag=='ok')
  {
    var userPhoto= window.parent.document.getElementById("paramsTask.task_pic");
    ...
    window.parent.document.getElementById("userImg").src="images/task/"+filename;
  }
  else if(flag=='no')
  {
    window.parent.document.getElementById("op").style.display="none";
    document.getElementById("upTip").innerHTML="${filename}";   
  }
-->        
</script>
</body>
