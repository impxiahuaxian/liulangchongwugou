...
$(document).ready(function(){
	 ...
	 $("#addBtn").bind('click',function(){
		...
		if(!num.exec($("#paramsUser\\.user_level").val())){
			alert('信用值必须为数字');
			return;
		}
   ...
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
       <tr>
        ...
        <tr>
          <td align="right" style="padding-right:5px"><font color="red">*</font> 家庭住址：</td>
          <td>
             <s:textfield type="text" id="paramsUser.user_address" name="paramsUser.user_address" value="%{#attr.user.user_address}"/>
          </td>
          <td align="right" style="padding-right:5px"><font color="red">*</font> 信用值：</td>
          <td>
             <s:textfield type="text" id="paramsUser.user_level" name="paramsUser.user_level" value="%{#attr.user.user_level}"/>级
          </td>
        </tr>   
     </table>
     </td>
