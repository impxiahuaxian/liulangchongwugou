...
<%@ page import="java.io.*" %>
<%@ page import="com.nkl.common.util.DateUtil" %>
<%
//错误信息
String errorMsg = "";
...
String current=application.getRealPath("/")+"images\\infos";
String saveurl=current+"\\"+file_name;

//文件保存目录URL
String saveUrl  = request.getContextPath()+"/images/infos/"+file_name;
